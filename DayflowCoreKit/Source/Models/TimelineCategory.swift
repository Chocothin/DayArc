    ...
    static var defaultCategories: [TimelineCategory] {
        ...
        let base: [(String, String, Bool, Bool, String)] = [
            (
                ...
                false,
                false,
                "Current job or school tasks ONLY: coding for employer, team meetings, work emails, assigned projects, work documentation. NOT personal career development."
            ),
            (
                "Personal",
                "#6AADFF",
                false,
                false,
                "Personal life activities: shopping, banking, fitness, hobbies, personal research, job hunting, interview prep, career development, resume writing, side projects, personal learning."
            ),
            (
                "Distraction",
                "#FF5950",
                false,
                false,
                "Mindless browsing or passive consumption: social media scrolling, random YouTube, news clicking, entertainment without purpose, gaming breaks."
            ),
            (
                "Idle",
                "#A0AEC0",
